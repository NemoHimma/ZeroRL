...
from networks import CategoricalDuelingDQN

from bodies import AtariBody

from timeit import default_timer as timer

class C51Agent(object):
    def __init__(self, config=None, env = None, log_dir='./experiments', static_policy=False):
        # CategoricalDuelingDQN Parameters
...
#######Tricks Selection #####################
        ...
        self.priority_replay = confg.USE_PRIORITY_REPLAY

###### Tricks Specification ##################
        # Noisy
...
########### Control Training Process ############
        ...
        self.traget_net_freq = config.TARGET_NET_UPDATE_FREQUENCY
    ...
    def declare_networks(self):
        self.model = CategoricalDuelingDQN(self.input_shape, self.num_actions, noisy = self.noisy, self.sigma_init, body = AtariBody)
        self.target_model = CategoricalDuelingDQN(self.input_shape, self.num_actions, noisy = self.noisy, self.sigma_init, body = AtariBody)

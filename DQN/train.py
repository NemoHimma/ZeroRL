    ...
    for frame_idx in tqdm(range(1, config.MAX_FRAMES+1)):
        ...
        if frame_idx % 10000 == 0:
            ...
            try:
                ...
                plot_all_data(log_dir, env_id, 'DQN', config.MAX_FRAMES, bin_size=(10, 100, 100, 1), save_filename = 'DQN1.png', smooth=1, time=timedelta(seconds=int(timer()-start)), ipynb=False)
            except IOError:
                pass
